...
* Daily Log Settings
  ...
  * Das passiert in "Blöcken" also eine Gruppe an "habits" (ein habit besteht aus einem Icon und einem Namen und man kann ein habit an einem Tag entweder auswählen oder nicht)
    * hier gibt es vorgefertigte Blöcke, die man selbst noch konfigurieren kann:
      * Emotions
      * Weather
      * Sleep
      * Health
      ...
      * Chores
      * Selfcare
    * und man kann selber Blöcke definieren, und habits
...
Tabs und Settings
Konkret die Daily Log Settings
